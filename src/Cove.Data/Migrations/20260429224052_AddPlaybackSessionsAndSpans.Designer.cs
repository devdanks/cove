...
namespace Cove.Data.Migrations
{
    ...
    [Migration("20260429224052_AddPlaybackSessionsAndSpans")]
    partial class AddPlaybackSessionsAndSpans
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Cove.Core.Entities.Interaction", b =>
                {
                    ...
                    b.HasIndex("UserId", "SessionId", "Kind", "At");
            ...
            modelBuilder.Entity("Cove.Core.Entities.PlaybackSession", b =>
                {
                    ...
                    b.Property<double>("LastReportedDurationSec")
                        .HasColumnType("double precision");
            ...
            modelBuilder.Entity("Cove.Core.Entities.PlaybackSpan", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<DateTime>("ObservedEndAt")
                        .HasColumnType("timestamp with time zone");

                    b.Property<DateTime>("ObservedStartAt")
                        .HasColumnType("timestamp with time zone");
                    ...
                    b.HasIndex("UserId", "HostType", "HostId", "StartSec", "EndSec");

                    b.ToTable("PlaybackSpans");
                });
            ...
            modelBuilder.Entity("Cove.Core.Entities.SegmentDisplayRule", b =>
                {
                    ...
                    b.HasIndex("SourceKey", "Kind", "TagId", "TagCategory", "HostType", "Priority");
            ...
            modelBuilder.Entity("Cove.Core.Entities.PlaybackSpan", b =>
                {
                    b.HasOne("Cove.Core.Entities.PlaybackSession", "PlaybackSession")
                        .WithMany("PlaybackSpans")
