        ...
        <form onSubmit={runDerivedQuery} className="mt-4 rounded-2xl border border-border bg-surface/40 p-4">
          <div className="flex flex-wrap items-start justify-between gap-3">
            <div>
              ...
              <p className="mt-2 text-sm text-secondary">Build a derived span set by intersecting, unioning, or subtracting raw segment criteria against the active display profile.</p>
            </div>
